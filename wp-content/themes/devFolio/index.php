          ...
          <div class="col-md-4">
            <div class="card card-blog">
              ...
              <div class="card-body">
                <div class="card-category-box">
                  <div class="card-category">
                    <h6 class="category text-light"><?php the_category(' | '); ?></h6>
                  </div>
                </div>
              ...
              <div class="card-footer">
                ...
                <div class="post-date">
                  <span class="bi bi-clock"></span>  <?php the_time('d-m-Y'); ?>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="title-box-2">
                      ...
                      <?php echo do_shortcode('[contact-form-7 id="7062e0d" title="mycontact-form"]'); ?>
